...
(/** @lends <global> */function( $ ) {
	...
	function _fnLanguageCompat( lang )
	{
		...
		if ( ! lang.sEmptyTable && zeroRecords &&
			defaults.sEmptyTable === "Datos no disponibles en la tabla" )
		{
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sEmptyTable": "No existen registros con esa descripción",
			 ...
			 *  @type string
			 *  @default existen registros con esa descripción
			 *
			 *  @dtopt Language
			 ...
			 *    } );
			 */
			"sZeroRecords": "No existen registros con esa descripción"
		},
