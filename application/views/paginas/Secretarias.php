  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Secretarías</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Secretarías</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div class="table-responsive">
                <table id="Secretarias" class="table table-bordered table-striped">
                  <thead>
                  <tr>
                    <th>Id Secretaría</th>
                    <th>Nombre</th>
                  ...
                  <tbody>
                    ...
                    <tr align="center" height="25">
                      <td><?php echo $item->idSecretaria; ?></td>
                      <td><?php echo $item->NombreS; ?></td>
                      <td><?php echo $item->DescripcionS; ?></td>
                      <td> 
                        <form action="cactualizarsecretaria" method="get">
                          <input name="ids" type="hidden" value="<?php echo $item->idSecretaria; ?>" />
                          <button name="editar" id="editar" type="submit" class="btn btn-warning"><i class="fa fa-edit" title="Editar secretaría"></button></i>
                        </form>
                      </td>      
                    </tr>    
                    <?php endforeach;?>
