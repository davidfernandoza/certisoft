      ...
      <div class="row">
        ...
        <?php
          ...
          <div class="alert alert-danger alert-dismissible" >
            ...
            El empleado que intenta guardar ya se encuentra almacenado en nuestra base de datos
          </div>
          <?php
            }
          ?>
          <div class="box box-header">
            <div class="box-body">  
              <form id="formID" role="form" action="cguardarempleado/guardar" method="get">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="nombre" placeholder="Nombre ..." required="" pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{1,50}" title="El campo solo debe contener letras" >
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="caja" placeholder="Ubicación ..." pattern="a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{1,50}" title="El campo puede  contener letras y números">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <table align="center" class="table table-bordered text-center">
                    <tr>
                      ...
                      <td width="250">
                        <form id="formID" role="form" action="cguardarempleado/cancel" method="get">
